...
seoDescription: "Headscale with no public DNS name and no Let's Encrypt: tui-cert runs a local CA, tui-tailscale trusts it on each client, and machines join with pre-auth keys."
cover: "/tools/tui-tailscale/tui-tailscale-trust.png"
coverCrop: { x: 100, y: 250, width: 760, height: 260 }
date: 2026-09-25
tools:
  - tui-tailscale
  - tui-cert
